...
BROKEN_TO_FIXED = {
    ...
    "Qu?n tr? TSA Aptis": _vi(r"Qu\u1ea3n tr\u1ecb TSA Aptis"),
    "Site qu?n tr? h? th?ng": _vi(r"Site qu\u1ea3n tr\u1ecb h\u1ec7 th\u1ed1ng"),
    "Trang ch?": _vi(r"Trang ch\u1ee7"),
    "Ng??i S? d?ng": _vi(r"Ng\u01b0\u1eddi s\u1eed d\u1ee5ng"),
    "Ng??i S? d?ng": _vi(r"Ng\u01b0\u1eddi s\u1eed d\u1ee5ng"),
    "X?c th?c v? ?y quy?n": _vi(r"X\u00e1c th\u1ef1c v\u00e0 \u1ee7y quy\u1ec1n"),
    "Ti?u ?? b?i h?c": _vi(r"Ti\u00eau \u0111\u1ec1 b\u00e0i h\u1ecdc"),
    "M? t?": _vi(r"M\u00f4 t\u1ea3"),
    "N?i dung": _vi(r"N\u1ed9i dung"),
    "C?u h?i": _vi(r"C\u00e2u h\u1ecfi"),
    "??p ?n": _vi(r"\u0110\u00e1p \u00e1n"),
}
...
print("DONE: ?? s?a d? li?u ti?ng Vi?t b? l?i trong database v? admin log.")
