...
# ===== Student Part 2 demo page =====
def listening_part2_demo_page(request):
    return render(request, "core/listening_part2.html")
# ===== End Student Part 2 demo page =====
'''
...
if "def student_part2_page(request):" not in v:
    v += r'''

# ===== Student listening Part 2 demo interface =====
def student_part2_page(request):
    return render(request, "core/listening_part2.html")
# ===== End Student listening Part 2 demo interface =====
'''
...
for f in [
    ...
    Path("templates/core/listening_page.html"),
]:
    if not f.exists():
        continue
    ...
    # Nếu đang có nút/tab Part 2 mà không có link rõ, ép về /listening/part-2/
    text = text.replace('href="?part=2"', 'href="/listening/part-2/"')
...
<head>
    <meta charset="UTF-8">
    <title>Listening Part 2 Demo | Aptis</title>
...
<body>
    ...
    <main class="part2-page">
        ...
        <section class="voice-list">
            ...
            <article class="voice-card">
                <div class="voice-info">
                    ...
                    <div>
                        <div class="voice-kicker">Câu {{ forloop.counter }} / 4</div>
                        <div class="voice-title">Câu {{ forloop.counter }}</div>

                        <div class="audio-row">
                            <button class="play-btn" type="button">▶</button>
                            <div class="fake-audio">
                                <span>0:{{ forloop.counter }}{{ forloop.counter }} / 0:25</span>
                                <div class="bar" style="--progress: {{ forloop.counter }}5%"></div>
                            </div>
        ...
        <section class="bottom-actions">
            <button class="btn btn-ghost" type="button" onclick="window.location.href='/listening/'">Previous Part</button>
...
print("DA_HIEN_DEMO_GIAO_DIEN_HOC_VIEN_PART2_KHI_CHUA_CO_DU_LIEU")
