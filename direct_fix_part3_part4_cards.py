...
for path in Path("templates").rglob("*.html"):
    ...
    if p3 != -1 and p4 != -1 and p3 < p4:
        ...
        block3 = block3.replace("Mở Part 4", "Mở Part 4")
        block3 = block3.replace("Mở Part 4", "Mở Part 4")
        block3 = block3.replace("Mở Part 4", "Mở Part 4")
        block3 = block3.replace('/dashboard/part-4/', '/dashboard/part-4/')
        block3 = block3.replace('/dashboard/part-4/', '/dashboard/part-4/')
        block3 = block3.replace('/dashboard/part-4/', '/dashboard/part-4/')
        block3 = block3.replace('/dashboard/part-4/', '/dashboard/part-4/')
        block3 = block3.replace('/dashboard/part-4/', '/dashboard/part-4/')
        ...
        block4 = block4.replace("Mở Part 4", "Mở Part 4")
        block4 = block4.replace("Mở Part 4", "Mở Part 4")
        block4 = block4.replace("Mở Part 4", "Mở Part 4")
        block4 = block4.replace('/dashboard/part-4/', '/dashboard/part-4/')
        block4 = block4.replace('/dashboard/part-4/', '/dashboard/part-4/')
        block4 = block4.replace('/dashboard/part-4/', '/dashboard/part-4/')
        block4 = block4.replace('/dashboard/part-4/', '/dashboard/part-4/')
        block4 = block4.replace('/dashboard/part-4/', '/dashboard/part-4/')
