...
.card:hover{
    ...
    box-shadow:0 24px 54px rgba(180,0,30,.12);
}
.num{
    width:58px;
    height:58px;
...
# ==================================================
# 5) Nếu trang listening chính có tab Part 2, ép nó đi về /listening/part-2/
# ==================================================
for p in Path("templates").rglob("*.html"):
    ...
    text = text.replace('href="/listening/part-2/may-dot/"', 'href="/listening/part-2/may-kem/"')

    if text != old:
        p.write_text(text, encoding="utf-8")
        print("DA_SUA_LINK_PART2:", p)

print("DA_THEM_MAN_CHON_MAY_GIOI_MAY_KEM_CHO_ADMIN_VA_HOC_VIEN")
