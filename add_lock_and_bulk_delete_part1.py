...
# =========================
# 1) Edit view: thêm xóa nhiều dòng đã chọn
# =========================
...
# =========================
# 2) Ghi lại interface Part 1 có khóa + xóa ngoài
# =========================
    ...
    <form method="post" class="bulk-card" id="bulkForm">
        ...
        <div class="bulk-head">
            <div>
                ...
                <p>Lock dòng để tránh sửa nhầm. Tích chọn rồi bấm “Delete dòng đã chọn” để xóa hàng loạt.</p>
            </div>
            ...
            <table id="part1Table">
                ...
                {% for q in questions %}
                    <tr>
                        ...
                        <td>
                            <button class="delete-btn" type="submit" name="delete_id" value="{{ q.id }}" onclick="return deleteOneRow(this)">Delete</button>
                        </td>
                    </tr>
                {% empty %}
                    <tr>
...
function deleteOneRow(btn){
    ...
    return confirm("Delete separate dòng này?");
}
